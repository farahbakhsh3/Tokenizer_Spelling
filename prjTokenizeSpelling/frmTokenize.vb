Public Class frmTokenize
    ...
    Dim alphaE As String = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"
    ...
    Private Sub saveToken(ByVal s As String)
        ...
        Dim Rep As Boolean = ListBox1.Items.Contains(s)
        If (Not Rep) Then
            Try
        ...
        If Rep And checkRepeated.Checked Then
